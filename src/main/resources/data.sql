...
INSERT INTO experiencia_profissional (id, nome_empresa, descricao_empresa, cargo, data_inicio, data_fim, descricao_experiencia, curriculo_id) VALUES (1, 'IBFC', 'Inst. Bras. deFormação e Capacitação', 'Analista de Suporte Computacional', '2014-05-01', '2015-06-01', 'Análise/Processamento de dados. Desenvolvimento de pequenas aplicações para uso interno (PHP)', 1);
INSERT INTO experiencia_profissional (id, nome_empresa, descricao_empresa, cargo, data_inicio, data_fim, descricao_experiencia, curriculo_id) VALUES (2, 'Tecnomira', '', 'Técnico em Eletrônica', '2013-04-01', '2014-05-01', 'Manutenção em controles remotos industriais e em paralelo. Desenvolvimento de aplicações para uso interno (JAVA)', 1);
INSERT INTO experiencia_profissional (id, nome_empresa, descricao_empresa, cargo, data_inicio, data_fim, descricao_experiencia, curriculo_id) VALUES (3, 'Control Service', '', 'Técnico em Eletrônica', '2012-04-01', '2013-04-01', 'Manutenção em terminais eletrônicos para fim de pagamento. Experiência com solda de componentes SMD', 1);
INSERT INTO experiencia_profissional (id, nome_empresa, descricao_empresa, cargo, data_inicio, data_fim, descricao_experiencia, curriculo_id) VALUES (4, 'Santander/Real', '', 'Aprendiz - Auxiliar Administrativo – Marketing', '2008-04-01', '2009-04-01', 'Organização de material publicitário. Elaboração de planilhas de controle para material distribuído. Elaboração da base de dados para confecção de relatórios.', 1);

INSERT INTO atividade_academica (id, titulo, descricao, detalhes) VALUES (1, 'Projeto Integrador IV', 'Desenvolvido durante o 1º semestre de 2015', 'Introdução - Desenvolvimento de um sistema Web que permita a escolha de um veículo, personalização do veículo escolhido e ao final de tudo emitir um descritivo do pedido com o endereço da concessionária mais próxima(previamente cadastrada no sistema).
